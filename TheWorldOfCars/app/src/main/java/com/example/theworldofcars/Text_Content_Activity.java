package com.example.theworldofcars;
...
public class Text_Content_Activity extends AppCompatActivity {
    ...
    private int[] array_facts = {R.string.facts1,R.string.facts2};
    private int[] array_persons = {R.string.persons1, R.string.persons2};

    private int[] array_image_american_cars = {
            R.drawable.ic_buick,
            R.drawable.ic_cadillac,
            R.drawable.ic_chevrolet,
            R.drawable.ic_chrysler,
            R.drawable.ic_dodge,
            R.drawable.ic_ford,
            R.drawable.ic_gmc,
            R.drawable.ic_hummer,
            R.drawable.ic_jeep,
            R.drawable.ic_lincoln,
            R.drawable.ic_tesla
    };
    private int[] array_image_european_cars = {R.drawable.ic_alfa_romeo, R.drawable.ic_aston_martin, R.drawable.ic_bentley, R.drawable.ic_bugatti,
            R.drawable.ic_citroen, R.drawable.ic_ferrari, R.drawable.ic_fiat, R.drawable.ic_jaguar, R.drawable.ic_lamborghini,
